...
- Use [Coral UI](/libraries/coral-ui/) for shared components and design tokens across apps
...
<CardGrid>
	...
	<Card title="Coral UI" icon="painting">
		Reusable React components and shared design tokens for consistent Coral interfaces.
	</Card>
